import pytest
from mp_api.routes.electronic_structure.client import ElectronicStructureRester

from pymatgen.analysis.magnetism import Ordering
import inspect
import typing

resters = [ElectronicStructureRester()]
...
custom_field_tests = {"magnetic_ordering": Ordering.FM}  # type: dict
