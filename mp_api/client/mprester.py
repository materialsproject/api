...
from typing import Dict, List, Literal, Optional, Union, TypeVar, Any
...
try:
    from emmet.core.electronic_structure import BSPathType as bs_path_type
    from emmet.core.mpid import MPID as mpid
    from emmet.core.tasks import TaskDoc as task_doc
    from emmet.core.vasp.calc_types import CalcType as calc_type
except ImportError:
    mpid = str
...
MPID = TypeVar("MPID", bound=mpid)
TaskDoc = TypeVar("TaskDoc", bound=task_doc)
CalcType = TypeVar("CalcType", bound=calc_type)
BSPathType = TypeVar("BSPathType", bound=bs_path_type)
